...
- **[bookcost/core/](bookcost/core/)** — pure logic:
  ...
  - [project_io.py](bookcost/core/project_io.py) — versioned JSON export/import of single projects (unknown columns ignored, missing default to NULL); DB backup/restore helpers live on `BookDatabase` (`backup_to`, `is_valid_database_file`), wired to the فایل menu in the main window.
